...
constraintList = [ "abstract-deque"
                 ...
                 , "charset"
                 , "cipher-aes"
                 , "citeproc"     -- pandoc doesn't support the latest version yet
                 , "clay"
                 , "clientsession"
                 , "clock"
                 , "cmark-gfm"
                 ...
                 , "css-text"
                 , "csv"
                 , "data-array-byte >=0.1.0.1 && <0.2 || >=0.1.0.1 && <0.2"
                 , "data-clist"
                 , "data-default"
                 , "data-default-class"
                 ...
                 , "dns"
                 , "doclayout"
                 , "doctemplates == 0.10.*"      -- constraint from pandoc
                 , "dotgen"
                 , "double-conversion"
                 , "easy-file"
                 , "echo"
                 ...
                 , "haskell-src-meta"
                 , "heaps"
                 , "hedgehog == 1.2.*"           -- keep tasty-hedgehog building
                 , "hedgehog-corpus"
                 , "hedgehog-quickcheck"
                 , "hi-file-parser"
                 , "hinotify"
